// Source1: https://github.com/ddgksf2013/Scripts/blob/master/bilibili_json_old.js
// Source2: https://github.com/ddgksf2013/Scripts/blob/master/bilibili_json.js
// author: @ddgksf2013
      ...
      case /^https?:\/\/app\.bilibili\.com\/x\/resource\/show\/tab/.test(
        ...
        try {
          ...
          const bottomList = new Set([
            177, 178, 179, 181, 102, 104, 106, 486, 488, 489,
          ]);
          let obj = JSON.parse(magicJS.response.body);
          if (obj["data"]["tab"]) {
        ...
        try {
          ...
          obj["data"]["sections_v2"].forEach((element, index) => {
            ...
            for (let ii = 0; ii < obj["data"]["sections_v2"].length; ii++) {
              if (
                obj.data.sections_v2[ii].title == "推荐服务" ||
                obj.data.sections_v2[ii].title == "推薦服務"
              ) {
                //obj.data.sections_v2[ii].items[0].title='\u516C\u773E\u865F';
                //obj.data.sections_v2[ii].items[1].title='\u58A8\u9B5A\u624B\u8A18';
              }
              if (
                obj.data.sections_v2[ii].title == "更多服務" ||
                obj.data.sections_v2[ii].title == "更多服务"
              ) {
              ...
              if (
                obj.data.sections_v2[ii].title == "创作中心" ||
                obj.data.sections_v2[ii].title == "創作中心"
              ) {
      ...
      case /^https?:\/\/app\.bilibili\.com\/x\/resource\/show\/skin\?/.test(
        ...
        try {
          ...
          if (
            ...
            obj.data.hasOwnProperty("common_equip") &&
            obj.data.common_equip.hasOwnProperty("package_url")
          ) {
