// https://github.com/Maasea/sgmodule/blob/master/Script/Youtube/youtube-player.js
!(function (i) {
  "use strict";
  function _(n, e, i) {
    return e <= n && n <= i;
...
class playerRes$Type extends MessageType {
  ...
  internalBinaryWrite(n, r, t) {
    for (let e = 0; e < n.b1F7.length; e++)
      b1f7
        .internalBinaryWrite(
          n.b1F7[e],
...
console.log(`youtube贴片广告:2022-10-19`);
