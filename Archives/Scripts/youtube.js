...
function normalizeFieldInfo(e) {
  var r;
  return (
    (e.localName = null != (r = e.localName) ? r : lowerCamelCase(e.name)),
    (e.jsonName = null != (r = e.jsonName) ? r : lowerCamelCase(e.name)),
    (e.repeat = null != (r = e.repeat) ? r : 0),
    (e.opt =
      null != (r = e.opt) ? r : !e.repeat && !e.oneof && "message" == e.kind),
    e
  );
}
        ...
        ? (t = s[i.oneof]).oneofKind === i.localName &&
          ((a =
            "scalar" == i.kind || "enum" == i.kind
              ? __spreadProps(__spreadValues({}, r), { emitDefaultValues: !0 })
              : r),
...
function reflectionMergePartial(e, r, t) {
  ...
  for (var i of e.fields) {
    ...
    if (i.oneof) {
      ...
      if (
        ((a = l[o]), ((s = r[i.oneof]).oneofKind = l.oneofKind), void 0 === a)
      ) {
        delete s[o];
        continue;
      }
...
class browseRes$Type extends MessageType {
  ...
  internalBinaryRead(e, n, t, r) {
    ...
    for (; e.pos < a; ) {
      ...
      switch (n) {
        case 9:
          i.n1F9 = n1F9.internalBinaryRead(e, e.uint32(), t, i.n1F9);
          break;
        case 10:
          i.n1F10 = n1F10.internalBinaryRead(e, e.uint32(), t, i.n1F10);
          break;
        default:
          ...
          let l = e.skip(r);
          !1 !== a &&
            (!0 === a ? UnknownFieldHandler.onRead : a)(
              this.typeName,
              i,
              n,
              r,
...
class n1F9$Type extends MessageType {
  ...
  internalBinaryRead(e, n, t, r) {
    ...
    for (; e.pos < a; ) {
      ...
      switch (n) {
        case 58173949:
          i.m2F58173949 = m2F58173949.internalBinaryRead(
            e,
            e.uint32(),
            t,
            i.m2F58173949,
...
class n1F10$Type extends MessageType {
  ...
  internalBinaryRead(e, n, t, r) {
    ...
    for (; e.pos < a; ) {
      ...
      switch (n) {
        case 49399797:
          i.n2F49399797 = n2F49399797.internalBinaryRead(
            e,
            e.uint32(),
            t,
            i.n2F49399797,
...
class m2F58173949$Type extends MessageType {
  ...
  internalBinaryRead(e, n, t, r) {
    ...
    for (; e.pos < a; ) {
      ...
      switch (n) {
        case 1:
          i.m3F1.push(m3F1.internalBinaryRead(e, e.uint32(), t));
          break;
        default:
          let a = t.readUnknownField;
          if ("throw" === a)
...
class m3F1$Type extends MessageType {
  ...
  internalBinaryRead(e, n, t, r) {
    ...
    for (; e.pos < a; ) {
      ...
      switch (n) {
        case 58174010:
          i.m4F58174010 = m4F58174010.internalBinaryRead(
            e,
            e.uint32(),
            t,
            i.m4F58174010,
...
class n2F49399797$Type extends MessageType {
  ...
  internalBinaryRead(e, n, t, r) {
    ...
    for (; e.pos < a; ) {
      ...
      switch (n) {
        case 1:
          i.n3F1.push(n3F1.internalBinaryRead(e, e.uint32(), t));
          break;
        default:
          let a = t.readUnknownField;
          if ("throw" === a)
...
class n3F1$Type extends MessageType {
  ...
  internalBinaryRead(e, n, t, r) {
    ...
    for (; e.pos < a; ) {
      ...
      switch (n) {
        case 50195462:
          i.n4F50195462 = n4F50195462.internalBinaryRead(
            e,
            e.uint32(),
            t,
            i.n4F50195462,
          ...
          break;
        case 51845067:
          i.n4F51845067 = n4F51845067.internalBinaryRead(
            e,
            e.uint32(),
            t,
            i.n4F51845067,
...
class n4F50195462$Type extends MessageType {
  ...
  internalBinaryRead(e, n, t, r) {
    ...
    for (; e.pos < a; ) {
      ...
      switch (n) {
        case 1:
          i.n5F1.push(n5F1.internalBinaryRead(e, e.uint32(), t));
          break;
        default:
          let a = t.readUnknownField;
          if ("throw" === a)
...
class n4F51845067$Type extends MessageType {
  constructor() {
    super("n4F51845067", [
  ...
  internalBinaryRead(e, n, t, r) {
    ...
    for (; e.pos < a; ) {
      ...
      switch (n) {
        case 5:
          i.n5F5 = n5F5.internalBinaryRead(e, e.uint32(), t, i.n5F5);
          break;
        default:
          let a = t.readUnknownField;
          if ("throw" === a)
...
class n5F1$Type extends MessageType {
  ...
  internalBinaryRead(e, n, t, r) {
    ...
    for (; e.pos < a; ) {
      ...
      switch (n) {
        case 153515154:
          i.n6F153515154 = n6F153515154.internalBinaryRead(
            e,
            e.uint32(),
            t,
            i.n6F153515154,
          ...
          break;
        case 166487981:
          i.n6F166487981 = n6F166487981.internalBinaryRead(
            e,
            e.uint32(),
            t,
            i.n6F166487981,
          ...
          break;
        case 62887855:
          i.n6F62887855 = n6F62887855.internalBinaryRead(
            e,
            e.uint32(),
            t,
            i.n6F62887855,
          ...
          break;
        case 157152291:
          i.n7F157152291 = n7F157152291.internalBinaryRead(
            e,
            e.uint32(),
            t,
            i.n7F157152291,
...
class n5F5$Type extends MessageType {
  constructor() {
    super("n5F5", [
      {
        no: 51431404,
  ...
  internalBinaryRead(e, n, t, r) {
    ...
    for (; e.pos < a; ) {
      ...
      switch (n) {
        case 51431404:
          i.n6F51431404 = n6F51431404.internalBinaryRead(
            e,
            e.uint32(),
            t,
            i.n6F51431404,
...
class n6F153515154$Type extends MessageType {
  ...
  internalBinaryRead(e, n, t, r) {
    ...
    for (; e.pos < a; ) {
      ...
      switch (n) {
        case 172660663:
          i.n7F172660663 = n7F172660663.internalBinaryRead(
            e,
            e.uint32(),
            t,
            i.n7F172660663,
...
class n6F51431404$Type extends MessageType {
  constructor() {
    super("n6F51431404", [
      { no: 1, name: "n5F1", kind: "message", repeat: 1, T: () => n5F1 },
    ]);
...
class n6F62887855$Type extends MessageType {
  constructor() {
    super("n6F62887855", []);
  }
  create(e) {
...
class n7F157152291$Type extends MessageType {
  constructor() {
    super("n7F157152291", []);
  }
  create(e) {
...
class n7F172660663$Type extends MessageType {
  ...
  internalBinaryRead(e, n, t, r) {
    ...
    for (; e.pos < a; ) {
      ...
      switch (n) {
        case 1:
          i.n8F1 = n8F1.internalBinaryRead(e, e.uint32(), t, i.n8F1);
          break;
        case 2:
          i.n8F2 = n8F2.internalBinaryRead(e, e.uint32(), t, i.n8F2);
          break;
        case 3:
          i.n8F3 = n8F3.internalBinaryRead(e, e.uint32(), t, i.n8F3);
          break;
        default:
          let a = t.readUnknownField;
          if ("throw" === a)
...
class n8F1$Type extends MessageType {
  ...
  internalBinaryRead(e, n, t, r) {
    ...
    for (; e.pos < a; ) {
      ...
      switch (n) {
        case 168777401:
          i.n9F168777401 = n9F168777401.internalBinaryRead(
            e,
            e.uint32(),
            t,
            i.n9F168777401,
...
class n8F2$Type extends MessageType {
  constructor() {
    super("n8F2", [
      {
        no: 183314536,
  ...
  internalBinaryRead(e, n, t, r) {
    ...
    for (; e.pos < a; ) {
      ...
      switch (n) {
        case 183314536:
          i.n9F183314536 = n9F183314536.internalBinaryRead(
            e,
            e.uint32(),
            t,
            i.n9F183314536,
...
class n9F168777401$Type extends MessageType {
  ...
  internalBinaryRead(e, n, t, r) {
    ...
    for (; e.pos < a; ) {
      ...
      switch (n) {
        case 3:
          i.n10F3 = n10F3.internalBinaryRead(e, e.uint32(), t, i.n10F3);
          break;
        default:
          let a = t.readUnknownField;
          if ("throw" === a)
...
class n9F183314536$Type extends MessageType {
  constructor() {
  ...
  internalBinaryWrite(e, n, t) {
    "" !== e.type && n.tag(1, WireType.LengthDelimited).string(e.type);
    let r = t.writeUnknownFields;
    return (
      !1 !== r &&
        (1 == r ? UnknownFieldHandler.onWrite : r)(this.typeName, e, n),
...
class n10F3$Type extends MessageType {
  ...
  internalBinaryRead(e, n, t, r) {
    ...
    for (; e.pos < a; ) {
      ...
      switch (n) {
        case 172035250:
          i.n11F172035250 = n11F172035250.internalBinaryRead(
            e,
            e.uint32(),
            t,
            i.n11F172035250,
...
class nextRes$Type extends MessageType {
  ...
  internalBinaryRead(e, n, t, r) {
    ...
    for (; e.pos < a; ) {
      ...
      switch (n) {
        case 7:
          i.a1F7 = a1F7.internalBinaryRead(e, e.uint32(), t, i.a1F7);
          break;
        case 8:
          i.a1F8 = a1F8.internalBinaryRead(e, e.uint32(), t, i.a1F8);
          break;
        default:
          let a = t.readUnknownField;
          if ("throw" === a)
...
class a1F7$Type extends MessageType {
  ...
  internalBinaryRead(e, n, t, r) {
    ...
    for (; e.pos < a; ) {
      ...
      switch (n) {
        case 51779735:
          i.a2F51779735 = a2F51779735.internalBinaryRead(
            e,
            e.uint32(),
            t,
            i.a2F51779735,
...
class a1F8$Type extends MessageType {
  constructor() {
    super("a1F8", [
      {
        no: 49399797,
...
class a2F51779735$Type extends MessageType {
  ...
  internalBinaryRead(e, n, t, r) {
    ...
    for (; e.pos < a; ) {
      ...
      switch (n) {
        case 1:
          i.a3F1 = a3F1.internalBinaryRead(e, e.uint32(), t, i.a3F1);
          break;
        default:
          let a = t.readUnknownField;
          if ("throw" === a)
...
class searchRes$Type extends MessageType {
  constructor() {
    super("searchRes", [
  ...
  internalBinaryRead(e, n, t, r) {
    ...
    for (; e.pos < a; ) {
      ...
      switch (n) {
        case 4:
          i.s1F4 = s1F4.internalBinaryRead(e, e.uint32(), t, i.s1F4);
          break;
        case 7:
          i.s1F7 = s1F7.internalBinaryRead(e, e.uint32(), t, i.s1F7);
          break;
        default:
          let a = t.readUnknownField;
          if ("throw" === a)
...
class s1F4$Type extends MessageType {
  constructor() {
    super("s1F4", [
      {
        no: 49399797,
...
class s1F7$Type extends MessageType {
  constructor() {
    super("s1F7", [
      {
        no: 50195462,
...
class shortsRes$Type extends MessageType {
  constructor() {
    super("shortsRes", [
  ...
  internalBinaryRead(e, n, t, r) {
    ...
    for (; e.pos < a; ) {
      ...
      switch (n) {
        case 2:
          i.t1F2.push(t1F2.internalBinaryRead(e, e.uint32(), t));
          break;
        default:
          let a = t.readUnknownField;
          if ("throw" === a)
...
class t1F2$Type extends MessageType {
  constructor() {
  ...
  internalBinaryRead(e, n, t, r) {
    ...
    for (; e.pos < a; ) {
      ...
      switch (n) {
        case 1:
          i.n2F1 = n2F1.internalBinaryRead(e, e.uint32(), t, i.n2F1);
          break;
        default:
          let a = t.readUnknownField;
          if ("throw" === a)
...
class n2F1$Type extends MessageType {
  constructor() {
    super("n2F1", [
      {
        no: 139608561,
  ...
  internalBinaryRead(e, n, t, r) {
    ...
    for (; e.pos < a; ) {
      ...
      switch (n) {
        case 139608561:
          i.n3F139608561 = n3F139608561.internalBinaryRead(
            e,
            e.uint32(),
            t,
            i.n3F139608561,
...
class n3F139608561$Type extends MessageType {
  constructor() {
    super("n3F139608561", [
  ...
  internalBinaryRead(e, n, t, r) {
    ...
    for (; e.pos < a; ) {
      ...
      switch (n) {
        case 8:
          i.n4F8 = n4F8.internalBinaryRead(e, e.uint32(), t, i.n4F8);
          break;
        default:
          let a = t.readUnknownField;
          if ("throw" === a)
...
class n4F8$Type extends MessageType {
  constructor() {
    super("n4F8", []);
  }
  create(e) {
...
class guideRes$Type extends MessageType {
  constructor() {
    super("guideRes", [
  ...
  internalBinaryRead(e, n, t, r) {
    ...
    for (; e.pos < a; ) {
      ...
      switch (n) {
        case 4:
          i.g1F4.push(g1F4.internalBinaryRead(e, e.uint32(), t));
          break;
        case 6:
          i.g1F6.push(g1F6.internalBinaryRead(e, e.uint32(), t));
          break;
        default:
          let a = t.readUnknownField;
          if ("throw" === a)
...
class g1F4$Type extends MessageType {
  constructor() {
    super("g1F4", [
      {
        no: 117866661,
  ...
  internalBinaryRead(e, n, t, r) {
    ...
    for (; e.pos < a; ) {
      ...
      switch (n) {
        case 117866661:
          i.g2F117866661 = g2F117866661.internalBinaryRead(
            e,
            e.uint32(),
            t,
            i.g2F117866661,
...
class g1F6$Type extends MessageType {
  constructor() {
    super("g1F6", [
      {
        no: 117866661,
...
class g2F117866661$Type extends MessageType {
  constructor() {
    super("g2F117866661", [
  ...
  internalBinaryRead(e, n, t, r) {
    ...
    for (; e.pos < a; ) {
      ...
      switch (n) {
        case 1:
          i.g3F1.push(g3F1.internalBinaryRead(e, e.uint32(), t));
          break;
        default:
          let a = t.readUnknownField;
          if ("throw" === a)
...
class g3F1$Type extends MessageType {
  constructor() {
    super("g3F1", [
      {
        no: 318370163,
  ...
  internalBinaryRead(e, n, t, r) {
    ...
    for (; e.pos < a; ) {
      ...
      switch (n) {
        case 318370163:
          i.g4F318370163 = g4F318370163.internalBinaryRead(
            e,
            e.uint32(),
            t,
            i.g4F318370163,
...
class g4F318370163$Type extends MessageType {
  constructor() {
    super("g4F318370163", []);
  }
  create(e) {
...
class playerRes$Type extends MessageType {
  constructor() {
    super("playerRes", [
      {
        no: 7,
  ...
  internalBinaryRead(e, n, r, t) {
    for (var a = null != t ? t : this.create(), i = e.pos + n; e.pos < i; ) {
      var [l, o] = e.tag();
      if (7 === l) a.b1F7.push(b1f7.internalBinaryRead(e, e.uint32(), r));
      else {
        ...
        var d = e.skip(o);
        !1 !== s &&
          (!0 === s ? UnknownFieldHandler.onRead : s)(
            this.typeName,
            a,
            l,
            o,
  ...
  internalBinaryWrite(e, n, r) {
    ...
    return (
      !1 !== t &&
        (1 == t ? UnknownFieldHandler.onWrite : t)(this.typeName, e, n),
      n
    );
  }
}
const playerRes = new playerRes$Type();
class b1f7$Type extends MessageType {
  constructor() {
    super("b1f7", [
      {
        no: 84813246,
  ...
  internalBinaryRead(e, n, r, t) {
    for (var a = null != t ? t : this.create(), i = e.pos + n; e.pos < i; ) {
      var [l, o] = e.tag();
      if (84813246 === l)
        a.b2F84813246 = b2f84813246.internalBinaryRead(
          e,
          e.uint32(),
          r,
          a.b2F84813246,
...
class b2f84813246$Type extends MessageType {
  constructor() {
    super("b2f84813246", [{ no: 3, name: "v", kind: "scalar", T: 5 }]);
  }
  create(e) {
    var n = { v: 0 };
    return (
  ...
  internalBinaryWrite(e, n, r) {
    return (
      0 !== e.v && n.tag(3, WireType.Varint).int32(e.v),
      !1 !== (r = r.writeUnknownFields) &&
        (1 == r ? UnknownFieldHandler.onWrite : r)(this.typeName, e, n),
      n
    );
...
if (url.includes("/v1/browse")) {
  ...
  browseMessage.n1F9?.m2F58173949?.m3F1?.forEach((ie) => {
    mapItems(ie.m4F58174010?.n1F10?.n2F49399797?.n3F1);
  });
  if (needProcessFlag) {
...
function removeAd(itemObject) {
  if (itemObject?.n5F1)
    itemObject.n5F1 = itemObject.n5F1?.filter((o) => isVideo(o));
}

function removeBanner(itemObject) {
  if (itemObject?.g3F1)
    itemObject.g3F1 = itemObject.g3F1?.filter((o) => isNotUpload(o));
}
...
function isVideo(o) {
  ...
  if (!ads) {
    let type =
      parseEml(o?.n6F153515154?.n7F172660663) ||
