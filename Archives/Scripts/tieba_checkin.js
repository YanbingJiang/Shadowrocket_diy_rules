...
*/
// reference: https://github.com/blackmatrix7/ios_rule_script/tree/master/script/tieba
// delete Cookie: $.data.del(tiebaCookiekey) // put after declaration
const scriptName = "百度贴吧签到";
const batchSize = 20;
...
async function multiUsersSignIn() {
  ...
  for (let [index, sessionKey] of allSessionskey.entries()) {
    ...
    //  $.logger.info(`Cookie: ${currentCookie}`); //review your cookie, donot leak
    if (!currentCookie) {
      continue;
    } else {
